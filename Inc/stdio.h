...
#else /* __AEABI_PORTABILITY_INTERNAL_LEVEL || defined(_NO_DEFINITIONS_IN_HEADER_FILES) */
...
#endif /* __AEABI_PORTABILITY_INTERNAL_LEVEL || defined(_NO_DEFINITIONS_IN_HEADER_FILES) */
